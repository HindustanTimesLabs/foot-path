...
function initMap() {
  ...
  $("input").keyup(function(e){
    ...
    if (isActive && e.which == 13){
      $("#go").removeClass("active").addClass("inactive").html("<i class='fa fa-spinner fa-pulse fa-fw'></i> Loading... <span class='sr-only'>Loading...</span>");
      $("html, body").animate({
        scrollTop: $("#search").offset().top - $(".navbar").height()
    }, 500);
